...
export const dom = {
    ...
    discoverView: query('#discoverView'),
    discoverSearch: query('#discoverSearch'),
    discoverFilters: Array.from(document.querySelectorAll('.discover-filter')),
    discoverGrid: query('#discoverGrid'),
    discoverEmpty: query('#discoverEmpty'),
    discoverCount: query('#discoverCount'),
    discoverShuffleBtn: query('#discoverShuffleBtn'),
    discoverResetBtn: query('[data-discover-action="reset-filters"]'),
